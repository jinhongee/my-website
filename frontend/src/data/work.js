...
const work = [
  {
    ...
    figure: 'FIG. 01 — POPULATION-SCALE AGENT DYNAMICS',
    figureRight: 'N-BODY / POLICY ROLLOUT',
    viz: SwarmViz,
    tagline:
      'LLM-parameterized cognitive architectures for population-scale behavioral simulation — persona-conditioned policies, memory-augmented reflection loops, and counterfactual rollouts over synthetic societies.',
  ...
  },
  {
    ...
    viz: NetworkViz,
    tagline:
      'Agentic orchestration over multi-echelon supply networks — hierarchical planners composed with constrained combinatorial solvers, probabilistic demand forecasting under nonstationarity, and closed-loop replenishment policies.',
  ...
  },
  {
    ...
    figure: 'FIG. 03 — DISTRIBUTED PRETRAINING LATTICE',
    figureRight: 'TP×PP SHARDING',
    viz: LatticeViz,
    tagline:
      'Sovereign AI model development on open weights — multilingual continual pretraining, tokenizer and embedding adaptation, SFT/RLHF alignment pipelines, and inference-optimized deployment on domestic compute.',
  ...
  },
  {
    ...
    figure: 'FIG. 04 — PASSIVE SONAR / LOFAR ANALYSIS',
    figureRight: 'BEARING-TIME PROCESSING',
    viz: SonarViz,
    tagline:
      'Passive-sonar automatic target recognition — spectro-temporal representation learning on LOFAR/DEMON spectrograms for discriminating submarine acoustic signatures under low SNR and heavy clutter.',
  ...
  },
  {
    ...
    figure: 'FIG. 05 — RECURRENT STATE-SPACE FORECASTING',
    figureRight: 'LSTM UNROLL / σ√τ CONE',
    viz: SequenceViz,
    tagline:
      'Gated recurrent architectures for equity time-series forecasting — LSTM state-space models over engineered market features — alongside large-scale catalog normalization and entity-resolution automation.',
